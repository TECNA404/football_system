...
const StatisticsPage = () => {
    ...
    const activityData = stats?.charts?.activity_over_time || [];
    ...
    const filteredActivityData = activityData.filter((item) => {
        ...
        const monthsBack = monthsMap[period];
                ...
                <div className="col-lg-6">
                    ...
                    >
                        <h4 className="fw-bold mb-4 d-flex align-items-center gap-2">
                            <BarChart
                                className="text-primary"/> {t('stats.goals_by_tournament') || "Goals by Tournament"}
                        </h4>
                    ...
                    >
                        <div className="d-flex justify-content-between align-items-center mb-4">
                            ...
                            >
                                ...
                                <option value="6m">Останні 6 місяців</option>
                                <option value="12m">Останні 12 місяців</option>
                        ...
                        <div style={{width: '100%', height: 300}}>
                            <ResponsiveContainer>
                                <LineChart data={filteredActivityData}>
                                    ...
                                    />
                                    <Line type="monotone" dataKey="matches" stroke="#00C49F" strokeWidth={3}
                        ...
                        <div className="row align-items-center">
                            ...
                            {stats?.win_rate || 0}%
                                    ...
                                    <div
                                        ...
                                        <span className="fw-bold text-primary small text-end"
                                              style={{maxWidth: '150px'}}>
                            {stats?.most_active_tournament || "N/A"}
                        </span>
                                    </div>
                                    <div
                                        className="list-group-item d-flex flex-column gap-2 pt-3 px-0 bg-transparent border-0">
                ...
                <div className="col-lg-4">
                    ...
                    >
                        ...
                        <div className="d-flex flex-column gap-3">
                            {[
                                {
                                    title: t('stats.ach_organizer'),
                                    icon: "🏆",
                                    condition: (stats?.tournaments_count >= 1)
                                },
                                ...
                                <div key={i}
                                     className={`d-flex align-items-center gap-3 p-3 rounded-3 ${ach.condition ? 'bg-primary-light border-primary-subtle' : 'bg-light opacity-50'}`}
